...
from raypath_core import *  # noqa: F403 - compatibility facade for the desktop application
from raypath_reporting import build_pdf_report
...
class RayPathMainWindow(QMainWindow):
    ...
    def save_project(self) -> bool:
        ...
        try:
            write_project_file(self.project_path, self._project_payload())
            self._set_dirty(False)
    ...
    def _load_project(self, path: Path) -> None:
        ...
        project_version = document.schema_version
